...
const MILESTONES = [
  ...
  {
    year: 2025.3,
    yearLabel: 'Апрель 2025',
    title: 'A2A-протокол',
    tag: 'Автономные агенты',
    description:
      'Появление открытых стандартов взаимодействия между агентами. Теперь AI-агенты могут не только выполнять задачи для человека, но и делегировать подзадачи другим специализированным агентам напрямую.',
  },
  {
    year: 2026,
